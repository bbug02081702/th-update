  ...
  <body>
    ...
    <div class="container">
      <div class="card">
        <div class="card-body">
          <div class="row">
              <form action="{{route('insert/user')}}" method="post" enctye="mutilpart/form-data">
                @csrf
                <div class="mb-3">
                    <label for="name" class="form-label">Name</label>
                    <input type="text" name="name" class="form-control" id="" placeholder="Nhap name">
                </div>
                <div class="mb-3">
                    <label for="email" class="form-label">Email</label>
                    <input type="email" name="email" class="form-control" id="" placeholder="Nhap email">
                </div>
                <div class="mb-3">
                    <label for="phone" class="form-label">So dien thoai</label>
                    <input type="text" name="phone" class="form-control" id="" placeholder="Nhap so dien thoai">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="role" class="form-control" id="" placeholder="Nhap quyen">
                </div>
